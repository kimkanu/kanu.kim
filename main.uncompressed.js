...
{
	if (region.bS.aP === region.ch.aP)
	{
		return 'on line ' + region.bS.aP;
	}
	return 'on lines ' + region.bS.aP + ' through ' + region.ch.aP;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dr: 'hidden', dj: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dr: 'mozHidden', dj: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dr: 'msHidden', dj: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dr: 'webkitHidden', dj: 'webkitvisibilitychange' }
		: { dr: 'hidden', dj: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.c0) && _Http_track(router, xhr, request.c0.a);

		try {
			xhr.open(request.dD, request.d_, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {T: fragment, ds: host, dL: path, cC: port_, cG: protocol, cH: query};
	});
...
var $author$project$Main$Loading = {$: 4};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {aa: frag, ae: params, Y: unvisited, N: value, ak: visited};
	});
...
var $author$project$Route$BlogList = function (a) {
	return {$: 2, a: a};
};
var $author$project$Route$BlogPost = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Route$Root = {$: 0};
var $author$project$Route$Shortener = {$: 1};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Route$Shortener,
			$elm$url$Url$Parser$s('shortener')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$BlogList,
			A2(
...
var $author$project$Main$BlogListMsg = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$BlogPost = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$BlogPostMsg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$Shortener = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$ShortenerMsg = function (a) {
	return {$: 1, a: a};
};
var $author$project$Page$BlogList$FetchIndex = $elm$core$Basics$identity;
var $author$project$Page$BlogList$Loading = function (a) {
	return {$: 0, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dd: false, dh: r.dh, dp: r.dp, cm: r.cm, dD: r.dD, dX: r.dX, c0: r.c0, d_: r.d_}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{dh: $elm$http$Http$emptyBody, dp: r.dp, cm: _List_Nil, dD: 'GET', dX: $elm$core$Maybe$Nothing, c0: $elm$core$Maybe$Nothing, d_: r.d_});
};
var $author$project$Page$BlogList$init = function (maybeCategory) {
	return _Utils_Tuple2(
		$author$project$Page$BlogList$Loading(maybeCategory),
		$elm$http$Http$get(
			{
				dp: $elm$http$Http$expectString($elm$core$Basics$identity),
				d_: '/posts/index.json'
			}));
};
var $author$project$Page$BlogPost$FetchPost = $elm$core$Basics$identity;
var $author$project$Page$BlogPost$Loading = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Page$BlogPost$init = F2(
	function (slug, frag) {
		return _Utils_Tuple2(
			A2($author$project$Page$BlogPost$Loading, slug, frag),
			$elm$http$Http$get(
				{
					dp: $elm$http$Http$expectString($elm$core$Basics$identity),
					d_: 'https://raw.githubusercontent.com/kimkanu/kanu.kim/gh-pages/posts/' + (slug + '.md')
				}));
	});
...
var $author$project$Page$Shortener$Empty = 3;
...
var $author$project$Main$mapPage = F4(
	function (model, toPage, toMsg, _v0) {
		...
		return _Utils_Tuple2(
			...
			A2(
				...
				A2($elm$core$Basics$composeL, $author$project$Main$PageMsg, toMsg),
				cmds));
	});
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Page$ScrollTo$scrollTo = _Platform_outgoingPort('scrollTo', $elm$json$Json$Encode$string);
...
var $author$project$Main$scrollToTop = function (_v0) {
	var model = _v0.a;
	var cmds = _v0.b;
	return _Utils_Tuple2(
		model,
...
var $author$project$Page$BlogPost$LoadingFailure = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Page$BlogPost$Success = function (a) {
	return {$: 3, a: a};
};
var $author$project$Page$BlogPost$YamlFailure = function (a) {
	return {$: 2, a: a};
};
var $author$project$Page$BlogPost$updateFragment = F2(
	function (fragment, model) {
		switch (model.$) {
			case 0:
				var m = model.a;
				return A2($author$project$Page$BlogPost$Loading, m, fragment);
			case 1:
				var m = model.a;
				return A2($author$project$Page$BlogPost$LoadingFailure, m, fragment);
			case 2:
				var m = model.a;
				return $author$project$Page$BlogPost$YamlFailure(
					_Utils_update(
						m,
						{T: fragment}));
			default:
				var m = model.a;
				return $author$project$Page$BlogPost$Success(
					_Utils_update(
						m,
						{T: fragment}));
		}
	});
var $author$project$Main$onNavigation = F2(
	function (model, prevRoute) {
		var scrollOrNot = function () {
			var _v3 = _Utils_Tuple2(model.aA, prevRoute);
			if (((_v3.a.$ === 3) && (!_v3.b.$)) && (_v3.b.a.$ === 3)) {
				var _v4 = _v3.a;
				var slug = _v4.a;
				var _v5 = _v3.b.a;
				var slug_ = _v5.a;
				return _Utils_eq(slug, slug_) ? $elm$core$Basics$identity : $author$project$Main$scrollToTop;
			} else {
		...
		return scrollOrNot(
			function () {
				...
				switch (_v0.$) {
					...
					case 1:
						return A4($author$project$Main$mapPage, model, $author$project$Main$Shortener, $author$project$Main$ShortenerMsg, $author$project$Page$Shortener$init);
					case 2:
						var maybeQuery = _v0.a;
						return A4(
							$author$project$Main$mapPage,
							model,
							$author$project$Main$BlogList,
							$author$project$Main$BlogListMsg,
							$author$project$Page$BlogList$init(maybeQuery));
					case 3:
						var slug = _v0.a;
						var frag = _v0.b;
						var _v1 = _Utils_Tuple2(prevRoute, model.u);
						if (((!_v1.a.$) && (_v1.a.a.$ === 3)) && (_v1.b.$ === 3)) {
							var _v2 = _v1.a.a;
							var slug_ = _v2.a;
							var m = _v1.b.a;
							return _Utils_eq(slug, slug_) ? A4(
								$author$project$Main$mapPage,
								model,
								$author$project$Main$BlogPost,
								$author$project$Main$BlogPostMsg,
								_Utils_Tuple2(
									A2($author$project$Page$BlogPost$updateFragment, frag, m),
									$author$project$Page$ScrollTo$scrollTo(
										A2($elm$core$Maybe$withDefault, '', frag)))) : A4(
								$author$project$Main$mapPage,
								model,
								$author$project$Main$BlogPost,
								$author$project$Main$BlogPostMsg,
								A2($author$project$Page$BlogPost$init, slug, frag));
						} else {
							return A4(
								$author$project$Main$mapPage,
								model,
							...
							_Utils_update(
								model,
								{
									u: $author$project$Main$Error(
										A2($author$project$Main$ErrorModel, 404, 'Not found.'))
								}),
							$elm$core$Platform$Cmd$none);
				}
			}());
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A2(
			$author$project$Main$onNavigation,
			{
				bx: key,
				u: $author$project$Main$Loading,
				aA: $author$project$Route$fromUrl(url)
			},
			$elm$core$Maybe$Nothing);
	});
...
var $author$project$Page$Shortener$ReceiveShortenedUrl = function (a) {
	return {$: 2, a: a};
};
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Page$Shortener$decodeShortenedUrl = $elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Page$Shortener$getShortenedUrl = _Platform_incomingPort('getShortenedUrl', $elm$json$Json$Decode$value);
var $author$project$Page$Shortener$subscriptions = function (_v0) {
	return $author$project$Page$Shortener$getShortenedUrl(
		A2($elm$core$Basics$composeR, $author$project$Page$Shortener$decodeShortenedUrl, $author$project$Page$Shortener$ReceiveShortenedUrl));
};
var $author$project$Main$subscriptions = function (model) {
	var subs = function () {
		var _v0 = model.u;
		if (_v0.$ === 1) {
			var shortenerModel = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$ShortenerMsg,
				$author$project$Page$Shortener$subscriptions(shortenerModel));
		} else {
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2($elm$core$Platform$Sub$map, $author$project$Main$PageMsg, subs)
			]));
};
...
var $author$project$Page$BlogList$JsonFailure = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Page$BlogList$LoadingFailure = function (a) {
	return {$: 1, a: a};
};
var $author$project$Page$BlogList$PostData = F5(
	function (slug, title, date, category, summary) {
		return {bo: category, ce: date, cT: slug, cY: summary, aj: title};
	});
var $author$project$Page$BlogList$Success = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cd: col, dk: contextStack, cD: problem, cP: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cP, s.cd, x, s.h));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{cd: 1, h: s.h, j: s.j, b: s.b + 1, cP: s.cP + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cd: s.cd + 1, h: s.h, j: s.j, b: newOffset, cP: s.cP, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.cP, s.cd, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cd: newCol, h: s.h, j: s.j, b: newOffset, cP: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cd: col, cD: problem, cP: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.cP, p.cd, p.cD);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cd: 1, h: _List_Nil, j: 1, b: 0, cP: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $justinmimbs$date$Date$fromIsoString = A2(
	...
	$elm$core$Result$mapError(
		A2(
			...
			$elm$core$String$join('; '))));
var $author$project$Page$BlogList$getCategory = function (m) {
	switch (m.$) {
		case 0:
			var q = m.a;
			return q;
...
var $author$project$Page$BlogList$highlightSyntaxList = _Platform_outgoingPort(
	'highlightSyntaxList',
	function ($) {
	...
	function (msg, model) {
		...
		if (response.$ === 1) {
			...
			var entryDecoder = A6(
				...
				$author$project$Page$BlogList$PostData,
			...
			var decoder = $elm$json$Json$Decode$list(entryDecoder);
			var decodedJson = A2($elm$json$Json$Decode$decodeString, decoder, indexJson);
			if (decodedJson.$ === 1) {
				var err = decodedJson.a;
				return _Utils_Tuple2(
					A2(
						$author$project$Page$BlogList$JsonFailure,
						$author$project$Page$BlogList$getCategory(model),
						$elm$json$Json$Decode$errorToString(err)),
					$elm$core$Platform$Cmd$none);
			} else {
				var postList = decodedJson.a;
				return _Utils_Tuple2(
					A2(
						$author$project$Page$BlogList$Success,
						$author$project$Page$BlogList$getCategory(model),
						postList),
					$author$project$Page$BlogList$highlightSyntaxList(0));
			}
		}
	});
var $author$project$Page$BlogPost$YamlData = F4(
	function (title, date, category, image) {
		return {bo: category, ce: date, du: image, aj: title};
	});
...
var $rtfeldman$elm_css$Css$color = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'color', c.N);
};
...
var $rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		aO: 0,
		dO: 0,
		N: $rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var $author$project$Util$Color$colorTheme = {
	de: $rtfeldman$elm_css$Css$hex('#d5d9dd'),
	b1: $rtfeldman$elm_css$Css$hex('#657786'),
	a$: $rtfeldman$elm_css$Css$hex('#1656cf'),
	a0: $rtfeldman$elm_css$Css$hex('#424242'),
	bw: $rtfeldman$elm_css$Css$hex('#77d4c1'),
	bA: $rtfeldman$elm_css$Css$hex('#4a7ddb'),
	dA: $rtfeldman$elm_css$Css$hex('#929da6'),
	bB: $rtfeldman$elm_css$Css$hex('#ea9cd7'),
	bE: $rtfeldman$elm_css$Css$hex('#E4E2B9'),
	bG: $rtfeldman$elm_css$Css$hex('#6AC3C9'),
	bK: $rtfeldman$elm_css$Css$hex('#FF9276'),
	bN: $rtfeldman$elm_css$Css$hex('#d583e0'),
	dO: $rtfeldman$elm_css$Css$hex('#E45B79'),
	bP: $rtfeldman$elm_css$Css$hex('#FF7372'),
	M: $rtfeldman$elm_css$Css$hex('#3a3a3c'),
	bV: $rtfeldman$elm_css$Css$hex('#7561ec')
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dl) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.dG, record.dl, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cb: charset, dm: finalDeclarations, cp: imports, cz: namespaces};
};
...
var $Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ao: charsProcessed, au: hash, ag: seed, aB: shift};
	});
...
var $Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.au)) ? (data.ag ^ A2(
		$Skinney$murmur3$Murmur3$multiplyBy,
		$Skinney$murmur3$Murmur3$c2,
		A2(
			$Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2($Skinney$murmur3$Murmur3$multiplyBy, $Skinney$murmur3$Murmur3$c1, data.au)))) : data.ag;
	var h0 = acc ^ data.ao;
...
var $Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.au | ((255 & $elm$core$Char$toCode(c)) << data.aB);
		var _v0 = data.aB;
		if (_v0 === 24) {
			return {
				ao: data.ao + 1,
			...
			return {ao: data.ao + 1, au: res, ag: data.ag, aB: data.aB + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cb: charset, dm: declarations, cp: imports, cz: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cb: $elm$core$Maybe$Nothing, cp: _List_Nil, cz: _List_Nil, cU: snippets};
};
...
var $rtfeldman$elm_css$Css$none = {am: 0, b7: 0, z: 0, c: 0, n: 0, dt: 0, cr: 0, by: 0, ax: 0, ac: 0, K: 0, g: 0, e: 0, bI: 0, bd: 0, dM: 0, G: 0, bg: 0, dQ: 0, aD: 0, ai: 0, C: 0, m: 0, dZ: 0, N: 'none'};
...
var $author$project$Page$BlogPost$customHtmlInline = function (inline) {
	if (inline.$ === 3) {
		var urlString = inline.a;
		var maybeTitle = inline.b;
		var inlines = inline.c;
		var url = $elm$url$Url$fromString(urlString);
		var path = A2(
			$elm$core$Maybe$map,
			function ($) {
				return $.dL;
		...
		return (_Utils_eq(
			host,
			$elm$core$Maybe$Just('')) || (_Utils_eq(
			host,
			$elm$core$Maybe$Just('kanu.kim')) && A2(
			$elm$core$Maybe$withDefault,
			false,
			A2(
				$elm$core$Maybe$map,
				A2(
					$elm$core$Basics$composeR,
					$elm$core$String$startsWith('/_'),
					$elm$core$Basics$not),
				path)))) ? A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href(urlString),
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.a$),
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$backgroundColor($author$project$Util$Color$colorTheme.a$)
								]))
						]))
				]),
			A2($elm$core$List$map, $author$project$Page$BlogPost$customHtmlInline, inlines)) : A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href(urlString),
			...
			A2($elm$core$List$map, $author$project$Page$BlogPost$customHtmlInline, inlines));
	} else {
		return $rtfeldman$elm_css$Html$Styled$fromUnstyled(
			A2(
				$pablohirafuji$elm_markdown$Markdown$Inline$defaultHtml,
				$elm$core$Maybe$Just(
					A2($elm$core$Basics$composeR, $author$project$Page$BlogPost$customHtmlInline, $rtfeldman$elm_css$Html$Styled$toUnstyled)),
				inline));
	}
};
...
var $author$project$Page$BlogPost$customHtmlBlock = function (block) {
	return A2(
		$elm$core$List$map,
		...
		A3(
			...
			$elm$core$Maybe$Just(
				A2(
					$elm$core$Basics$composeR,
					$author$project$Page$BlogPost$customHtmlBlock,
					$elm$core$List$map($rtfeldman$elm_css$Html$Styled$toUnstyled))),
			$elm$core$Maybe$Just(
				A2($elm$core$Basics$composeR, $author$project$Page$BlogPost$customHtmlInline, $rtfeldman$elm_css$Html$Styled$toUnstyled)),
			block));
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.b, s.cP, s.cd, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			...
			0,
			{cd: newCol, h: s.h, j: s.j, b: adjustedOffset, cP: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$getCol = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.cd, s);
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cd: col, h: s0.h, j: s0.j, b: offset, cP: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.cP, s.cd, s);
	};
};
			...
			return $elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						...
						$elm$parser$Parser$symbol('\n...\n')),
						_Utils_eq(actual, indent) ? next.a5 : ((_Utils_cmp(actual, indent) > 0) ? next.a8(actual) : next.bj)
					]));
		};
		return A2(
			$elm$parser$Parser$andThen,
...
var $terezka$yaml$Yaml$Parser$listElementValue = function (indent) {
	return A2(
		...
		indent,
		{
			a4: $elm$parser$Parser$succeed($terezka$yaml$Yaml$Parser$Ast$Null_),
			a5: $elm$parser$Parser$succeed($terezka$yaml$Yaml$Parser$Ast$Null_),
			a8: function (indent_) {
				return $elm$parser$Parser$oneOf(
					_List_fromArray(
						[
			...
			bj: $elm$parser$Parser$succeed($terezka$yaml$Yaml$Parser$Ast$Null_)
		});
};
var $terezka$yaml$Yaml$Parser$listStep = F2(
	function (indent, values) {
		...
		return A2(
			...
			indent,
			{
				a4: $elm$parser$Parser$succeed(finish),
				a5: $elm$parser$Parser$oneOf(
					_List_fromArray(
						[
							A2(
							$elm$parser$Parser$keeper,
...
var $author$project$Page$BlogPost$getFragment = function (model) {
	switch (model.$) {
		case 0:
			var fragment = model.b;
			return fragment;
		case 1:
			var fragment = model.b;
			return fragment;
...
var $author$project$Page$BlogPost$getSlug = function (model) {
	switch (model.$) {
		case 0:
			var slug = model.a;
			return slug;
...
var $author$project$Page$BlogPost$highlightSyntax = _Platform_outgoingPort(
	'highlightSyntax',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $terezka$yaml$Yaml$Decode$map = F2(
	function (func, _v0) {
		var a = _v0;
		return function (v0) {
			var _v1 = a(v0);
...
var $terezka$yaml$Yaml$Decode$map4 = F5(
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {dw: index, dB: match, dH: number, dV: submatches};
	});
...
var $pablohirafuji$elm_markdown$Markdown$Block$calcListIndentLength = function (_v0) {
	...
	var indentLength = (isIndentedCode || A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$Block$blankLineRegex, rawLine)) ? (listBlock.s - indentSpaceLength) : listBlock.s;
	return _Utils_Tuple2(
		_Utils_update(
			listBlock,
			{s: indentLength}),
		...
		if (!asts.b) {
			return _List_fromArray(
				[
					_List_fromArray(
					[
						$pablohirafuji$elm_markdown$Markdown$Block$BlankLine(match.dB)
					])
				]);
		} else {
			var ast = asts.a;
	...
	if (((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
		...
		return $elm$core$Maybe$Just(
			_Utils_Tuple3(
				{
					aM: delimiter,
					s: $elm$core$String$length(indentString) + 1,
					U: false,
					aV: A2(
						$elm$core$Maybe$withDefault,
			...
			_Utils_Tuple3(
				{
					...
					s: $elm$core$String$length(indentString) + 1,
					U: false,
					aV: $pablohirafuji$elm_markdown$Markdown$Block$Unordered
				},
				A2($elm$core$Maybe$withDefault, '', maybeIndentSpace),
				A2($elm$core$Maybe$withDefault, '', maybeRawLine)));
	} else {
...
var $pablohirafuji$elm_markdown$Markdown$Block$continueOrCloseCodeFence = F3(
	function (fence, previousCode, rawLine) {
		return A2($pablohirafuji$elm_markdown$Markdown$Block$isCloseFenceLine, fence, rawLine) ? A2(
			...
			$pablohirafuji$elm_markdown$Markdown$Block$CodeBlock,
			A2($pablohirafuji$elm_markdown$Markdown$Block$Fenced, true, fence),
			previousCode + (A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, fence.s, rawLine) + '\n'));
	});
				...
				switch (ast.a.$) {
					...
					case 6:
						...
						return (_Utils_cmp(
							...
							model.s) > -1) ? A5($pablohirafuji$elm_markdown$Markdown$Block$parseIndentedListLine, rawLine, model, items, ast, astTail) : A2(
				...
				A2(
					...
					function (a) {
						...
						function (a) {
							...
							A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.s, rawLine)))));
		} else {
			var item = items.a;
			var itemsTail = items.b;
			var indentedRawLine = A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.s, rawLine);
					...
					switch (item.a.$) {
						...
						case 6:
							...
							return (_Utils_cmp(
								...
								model_.s) > -1) ? updateList(model) : ($pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items_) ? updateList(
								_Utils_update(
									model,
...
var $pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions = {b$: $pablohirafuji$elm_markdown$Markdown$Config$defaultAllowedHtmlAttributes, b0: $pablohirafuji$elm_markdown$Markdown$Config$defaultAllowedHtmlElements};
var $pablohirafuji$elm_markdown$Markdown$Config$defaultOptions = {
	cJ: $pablohirafuji$elm_markdown$Markdown$Config$Sanitize($pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions),
	cV: false
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$initParser = F3(
	function (options, refs, rawText) {
		return {d: _List_Nil, ay: options, y: rawText, bQ: refs, k: _List_Nil};
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{ch: childMatch.ch - parentMatch.H, bS: childMatch.bS - parentMatch.H, aE: childMatch.aE - parentMatch.H, H: childMatch.H - parentMatch.H});
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_v0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.ch, match.bS) < 1) ? A2($elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.bS, match.bS) < 0) && (_Utils_cmp(prevMatch.ch, match.ch) > 0)) ? A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		aE: 0,
		H: 0,
		aV: $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				d: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.M, _List_Nil, matchModel.d)
			});
		if (!parsedMatches.b) {
			var finalStr = A2($elm$core$String$dropLeft, matchModel.ch, rawText);
			...
			return _Utils_eq(matchHead.aV, $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.ch, matchHead.bS) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.ch, matchHead.bS) < 0) ? A2(
				$elm$core$List$cons,
				updtMatch,
				A2(
					$elm$core$List$cons,
					$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3($elm$core$String$slice, matchModel.ch, matchHead.bS, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.bS > 0) ? A2(
						$elm$core$List$cons,
						$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
							A2($elm$core$String$left, matchModel.bS, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseText = function (model) {
	return _Utils_update(
		model,
		{
			d: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, model.y, _List_Nil, model.d)
		});
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{
				dw: regMatch.dw + backslashesLength,
				f: 1,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToEmphasisToken = F3(
	function (_char, rawText, regMatch) {
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) {
			...
			var mLeftFringe = ((!(!regMatch.dw)) && (!leftFringeLength)) ? $elm$core$Maybe$Just(
				A3($elm$core$String$slice, regMatch.dw - 1, regMatch.dw, rawText)) : maybeLeftFringe;
			var backslashesLength = A2(
				$elm$core$Maybe$withDefault,
				0,
				A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
			...
			var index = ((regMatch.dw + backslashesLength) + leftFringeLength) + (isEscaped ? 1 : 0);
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{dw: (regMatch.dw + backslashesLength) - 1, f: 2, i: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							dw: regMatch.dw,
							f: $elm$core$String$length(regMatch.dB),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{dw: regMatch.dw + backslashesLength, f: 1, i: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{dw: (regMatch.dw + backslashesLength) - 1, f: 2, i: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		var index = (regMatch.dw + backslashesLength) + ((isEscaped && _Utils_eq(
			maybeImageOpen,
			...
			k: A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.ay.cV, model.y),
							_Utils_ap(
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$addToken = F2(
	function (model, token) {
		return _Utils_update(
			model,
			{
				k: A2($elm$core$List$cons, token, model.k)
			});
	});
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.dB,
				$elm$url$Url$percentDecode(match.dB));
		}));
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	...
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.M) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				aV: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.M,
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						ch: matchModel.ch + $elm$core$String$length(regexMatch.dB),
						aV: function () {
							var _v5 = matchModel.aV;
							if (_v5.$ === 5) {
	...
	function (matchModel, model, maybeRegexMatch) {
		...
		var toMatch = function (urlTitle) {
			return _Utils_update(
				matchModel,
				{
					ch: matchModel.ch + regexMatchLength,
					aV: function () {
						var _v0 = matchModel.aV;
						if (_v0.$ === 5) {
							return $pablohirafuji$elm_markdown$Markdown$InlineParser$ImageType;
						} else {
							return $pablohirafuji$elm_markdown$Markdown$InlineParser$LinkType;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_v0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.ch, testMatch.bS) > 0) && (_Utils_cmp(match.ch, testMatch.ch) < 0);
			},
			remainMatches);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$filterTokens = F2(
	function (filter, model) {
		return _Utils_update(
			model,
			{
				k: A2($elm$core$List$filter, filter, model.k)
			});
	});
	...
	function (model, match, regexMatch) {
		...
		if ((((_v0.b && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) && _v0.b.b.b.b) {
			...
			switch (_v4.$) {
				...
				case 1:
					var allowedHtmlElements = _v4.a.b0;
					var allowedHtmlAttributes = _v4.a.b$;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$reverseTokens = function (model) {
	return _Utils_update(
		model,
		{
			k: $elm$core$List$reverse(model.k)
		});
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {ch: token.dw + token.f, d: _List_Nil, bS: token.dw, M: '', aE: 0, H: 0, aV: type_};
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_v0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.i, $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.i, $pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.ay.cV)) {
		...
		if (!_v0.b) {
			...
			return _Utils_Tuple2(
				A2(
					$elm$core$List$filter,
					function (token) {
						return _Utils_cmp(token.dw, match.ch) > -1;
					},
					tokensTail),
				parser);
		}
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$codeToMatch = F3(
	function (closeToken, model, _v20) {
		...
		var updtOpenToken = _Utils_eq(
			...
			openToken,
			{dw: openToken.dw + 1, f: openToken.f - 1}) : openToken;
		return _Utils_update(
			model,
			{
				d: A2(
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emphasisToMatch = F4(
	function (closeToken, tokensTail, model, _v15) {
		...
		var updt = (!remainLength) ? {a2: closeToken, aQ: openToken, bf: remainTokens, bm: tokensTail} : ((remainLength > 0) ? {
			a2: closeToken,
			aQ: _Utils_update(
				openToken,
				{dw: openToken.dw + remainLength, f: closeToken.f}),
			bf: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			bm: A2(
				...
				_Utils_update(
					closeToken,
					{dw: closeToken.dw + openToken.f, f: -remainLength}),
				tokensTail)
		});
		var match = A6(
			$pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$pablohirafuji$elm_markdown$Markdown$InlineParser$EmphasisType(updt.aQ.f),
			updt.aQ,
			updt.a2,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple2(
				...
				return $pablohirafuji$elm_markdown$Markdown$InlineParser$linkImageTypeTTM(
					A2(
						...
						A2(
							...
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findToken, $pablohirafuji$elm_markdown$Markdown$InlineParser$isLinkTypeOrImageOpenToken, model.k))));
			} else {
	...
	function (closeToken, tokensTail, model, _v1) {
		...
		var removeOpenToken = _Utils_Tuple2(
			...
			_Utils_update(
				model,
				{
					k: _Utils_ap(innerTokens, remainTokens)
				}));
		var remainText = A2($elm$core$String$dropLeft, closeToken.dw + 1, model.y);
		var linkOpenTokenToInactive = function (model_) {
			...
			return _Utils_update(
				model_,
				{
					k: A2($elm$core$List$map, process, model_.k)
				});
		};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F6(
	function (model, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.dw + openToken.f;
		var textEnd = closeToken.dw;
		var start = openToken.dw;
		var end = closeToken.dw + closeToken.f;
		var match = {
			ch: end,
			d: _List_Nil,
			bS: start,
...
var $pablohirafuji$elm_markdown$Markdown$Block$dropRefString = F2(
	function (rawText, inlineMatch) {
		var strippedText = A2($elm$core$String$dropLeft, inlineMatch.bC, rawText);
...
var $pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2($elm$core$Dict$member, linkMatch.ab, refs) ? refs : A3(
			...
			linkMatch.ab,
			_Utils_Tuple2(linkMatch.d_, linkMatch.bD),
			refs);
	});
var $pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				ab: rawText,
				bC: $elm$core$String$length(regexMatch.dB),
				bD: $pablohirafuji$elm_markdown$Markdown$Helpers$returnFirstJust(
					_List_fromArray(
						[maybeTitleSingleQuotes, maybeTitleDoubleQuotes, maybeTitleParenthesis])),
				d_: rawUrl
			};
...
var $pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		$elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.d_ === '') || (linkMatch.ab === '')) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(linkMatch);
		},
		A2(
			$elm$core$Maybe$map,
			function (linkMatch) {
...
var $author$project$Page$BlogPost$MarkdownWithYaml = F2(
	function (yaml, markdown) {
		return {cx: markdown, da: yaml};
	});
var $author$project$Page$BlogPost$separateYaml = function (markdownWithYaml) {
	var splitted = A2($elm$core$String$split, '---', markdownWithYaml);
	if (!splitted.b) {
		return A2($author$project$Page$BlogPost$MarkdownWithYaml, $elm$core$Maybe$Nothing, markdownWithYaml);
	} else {
		if (!splitted.b.b) {
			return A2($author$project$Page$BlogPost$MarkdownWithYaml, $elm$core$Maybe$Nothing, markdownWithYaml);
		} else {
			...
			var rest = _v1.b;
			return A2(
				$author$project$Page$BlogPost$MarkdownWithYaml,
				$elm$core$Maybe$Just(yaml),
				A2($elm$core$String$join, '---', rest));
		}
	}
};
var $terezka$yaml$Yaml$Decode$sometimes = function (decoder) {
	return function (v) {
		var _v0 = A2($terezka$yaml$Yaml$Decode$fromValue, decoder, v);
		if (!_v0.$) {
			var a = _v0.a;
			return $elm$core$Result$Ok(
...
var $author$project$Page$BlogPost$update = F2(
	function (msg, model) {
		var response = msg;
		if (response.$ === 1) {
			return _Utils_Tuple2(
				A2(
					$author$project$Page$BlogPost$LoadingFailure,
					$author$project$Page$BlogPost$getSlug(model),
					$author$project$Page$BlogPost$getFragment(model)),
				$elm$core$Platform$Cmd$none);
		} else {
			var markdownWithYaml = response.a;
			var yamlDecoder = A5(
				$terezka$yaml$Yaml$Decode$map4,
				$author$project$Page$BlogPost$YamlData,
				A2($terezka$yaml$Yaml$Decode$field, 'title', $terezka$yaml$Yaml$Decode$string),
				A2($terezka$yaml$Yaml$Decode$field, 'date', $terezka$yaml$Yaml$Decode$string),
				A2(
					$terezka$yaml$Yaml$Decode$field,
					'category',
					$terezka$yaml$Yaml$Decode$list(
						A2($terezka$yaml$Yaml$Decode$map, $elm$core$String$trim, $terezka$yaml$Yaml$Decode$string))),
				$terezka$yaml$Yaml$Decode$sometimes(
					A2($terezka$yaml$Yaml$Decode$field, 'image', $terezka$yaml$Yaml$Decode$string)));
			var content = $author$project$Page$BlogPost$separateYaml(markdownWithYaml);
			var decodedMarkdown = $elm$core$List$concat(
				A2(
					$elm$core$List$map,
					$author$project$Page$BlogPost$customHtmlBlock,
					A2($pablohirafuji$elm_markdown$Markdown$Block$parse, $elm$core$Maybe$Nothing, content.cx)));
			var decodedYaml = A2(
				$elm$core$Maybe$map,
				$terezka$yaml$Yaml$Decode$fromString(yamlDecoder),
				content.da);
			if (decodedYaml.$ === 1) {
				return _Utils_Tuple2(
					$author$project$Page$BlogPost$YamlFailure(
						{
							br: 'Missing yaml metadata.',
							T: $author$project$Page$BlogPost$getFragment(model),
							be: markdownWithYaml,
							cT: $author$project$Page$BlogPost$getSlug(model)
						}),
					$elm$core$Platform$Cmd$none);
			} else {
				var justDecodedYaml = decodedYaml.a;
				if (!justDecodedYaml.$) {
					var yaml = justDecodedYaml.a;
					return _Utils_Tuple2(
						$author$project$Page$BlogPost$Success(
							{
								bo: yaml.bo,
								bp: decodedMarkdown,
								ce: $elm$core$Result$toMaybe(
									$justinmimbs$date$Date$fromIsoString(yaml.ce)),
								T: $author$project$Page$BlogPost$getFragment(model),
								be: markdownWithYaml,
								cT: $author$project$Page$BlogPost$getSlug(model),
								aj: yaml.aj
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Page$BlogPost$highlightSyntax(0),
									$author$project$Page$ScrollTo$scrollTo(
									A2(
										$elm$core$Maybe$withDefault,
										'',
...
var $author$project$Page$Shortener$NotShortened = 0;
var $author$project$Page$Shortener$Processing = 1;
var $author$project$Page$Shortener$Shortened = 2;
...
var $author$project$Page$Shortener$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var newUrl = msg.a;
					...
					case 0:
						return _Utils_Tuple2(
							...
							$author$project$Page$Shortener$shorten(
								$elm$json$Json$Encode$string(model.d_)));
					case 2:
						return _Utils_Tuple2(
							model,
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							v: 2,
							d_: 'kanu.kim/_' + A2($elm$core$Result$withDefault, model.d_, newUrl)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var pageMsg = msg.a;
				var _v1 = _Utils_Tuple2(model.u, pageMsg);
				_v1$4:
				while (true) {
					switch (_v1.b.$) {
						case 0:
							if (!_v1.a.$) {
								...
								return A4(
									...
									A2($author$project$Page$Home$update, homeMsg, model_));
							} else {
								break _v1$4;
							}
						case 1:
							if (_v1.a.$ === 1) {
								var model_ = _v1.a.a;
								var shortenerMsg = _v1.b.a;
								return A4(
									$author$project$Main$mapPage,
									model,
									$author$project$Main$Shortener,
									$author$project$Main$ShortenerMsg,
									A2($author$project$Page$Shortener$update, shortenerMsg, model_));
							} else {
								break _v1$4;
							}
						case 2:
							if (_v1.a.$ === 2) {
								var model_ = _v1.a.a;
								var blogListMsg = _v1.b.a;
								return A4(
									$author$project$Main$mapPage,
									model,
									$author$project$Main$BlogList,
									$author$project$Main$BlogListMsg,
									A2($author$project$Page$BlogList$update, blogListMsg, model_));
							} else {
								break _v1$4;
							}
						default:
							if (_v1.a.$ === 3) {
								var model_ = _v1.a.a;
								var blogPostMsg = _v1.b.a;
								return A4(
									$author$project$Main$mapPage,
									model,
									$author$project$Main$BlogPost,
									$author$project$Main$BlogPostMsg,
									A2($author$project$Page$BlogPost$update, blogPostMsg, model_));
							} else {
								break _v1$4;
							}
					}
...
var $rtfeldman$elm_css$Css$row = {bv: 0, aN: 0, N: 'row'};
...
var $author$project$Page$BlogList$viewEmpty = _List_fromArray(
	[
		A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							['Mosk'])),
						$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.M)
					]))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Empty!')
					]))
			]))
	]);
...
var $author$project$Page$BlogList$viewHeader = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$src($author$project$Util$Logo$smallLogoImage),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$width(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('kanu.kim/')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													['Mosk'])),
												$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.a0)
											]))
									]),
								_List_fromArray(
									[
...
var $author$project$Page$BlogList$viewLoading = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
...
var $rtfeldman$elm_css$Css$borderBox = {bn: 0, a1: 0, N: 'border-box'};
var $rtfeldman$elm_css$Css$boxSizing = $rtfeldman$elm_css$Css$prop1('box-sizing');
var $author$project$Util$Icon$Calendar = 0;
var $author$project$Util$Icon$calendar = 0;
var $rtfeldman$elm_css$Html$Styled$h2 = $rtfeldman$elm_css$Html$Styled$node('h2');
var $author$project$Util$Icon$icon = F2(
	function (c, i) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$span,
			_List_fromArray(
...
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.db, 0, date.bL);
};
...
var $justinmimbs$date$Date$language_en = {
	bq: $justinmimbs$date$Date$withOrdinalSuffix,
...
var $author$project$Util$Date$dateToString = $justinmimbs$date$Date$format('MMM ddd, y');
var $author$project$Util$Date$maybeDateToString = A2(
	$elm$core$Basics$composeL,
	$elm$core$Maybe$withDefault('Someday'),
	$elm$core$Maybe$map($author$project$Util$Date$dateToString));
var $author$project$Page$BlogList$customHtmlInline = function (inline) {
	if (inline.$ === 3) {
		var urlString = inline.a;
		var maybeTitle = inline.b;
		var inlines = inline.c;
		...
		return (_Utils_eq(
			...
			A2($elm$core$List$map, $author$project$Page$BlogList$customHtmlInline, inlines)) : A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href(urlString),
			...
			A2($elm$core$List$map, $author$project$Page$BlogList$customHtmlInline, inlines));
	} else {
		return $rtfeldman$elm_css$Html$Styled$fromUnstyled(
			A2(
				$pablohirafuji$elm_markdown$Markdown$Inline$defaultHtml,
				$elm$core$Maybe$Just(
					A2($elm$core$Basics$composeR, $author$project$Page$BlogList$customHtmlInline, $rtfeldman$elm_css$Html$Styled$toUnstyled)),
				inline));
	}
};
var $author$project$Page$BlogList$customHtmlBlock = function (block) {
	return A2(
		$elm$core$List$map,
		$rtfeldman$elm_css$Html$Styled$fromUnstyled,
		A3(
			...
			$elm$core$Maybe$Just(
				A2(
					$elm$core$Basics$composeR,
					$author$project$Page$BlogList$customHtmlBlock,
					$elm$core$List$map($rtfeldman$elm_css$Html$Styled$toUnstyled))),
			$elm$core$Maybe$Just(
				A2($elm$core$Basics$composeR, $author$project$Page$BlogList$customHtmlInline, $rtfeldman$elm_css$Html$Styled$toUnstyled)),
			block));
};
var $author$project$Page$BlogList$renderMarkdown = function (markdown) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			$author$project$Page$BlogList$customHtmlBlock,
			A2($pablohirafuji$elm_markdown$Markdown$Block$parse, $elm$core$Maybe$Nothing, markdown)));
};
...
var $author$project$Util$Color$hashString = function (mod) {
	var hash = function (a) {
		return function (b) {
			return a + b;
		};
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$List$foldl,
					A2($elm$core$Basics$composeL, hash, mod),
					0),
				mod)));
};
var $author$project$Util$Color$getColorFromString = function (s) {
	var defaultColor = $author$project$Util$Color$colorTheme.dA;
	var colorList = _List_fromArray(
		[$author$project$Util$Color$colorTheme.dA, $author$project$Util$Color$colorTheme.b1, $author$project$Util$Color$colorTheme.dO, $author$project$Util$Color$colorTheme.bP, $author$project$Util$Color$colorTheme.bK, $author$project$Util$Color$colorTheme.bE, $author$project$Util$Color$colorTheme.bw, $author$project$Util$Color$colorTheme.bG, $author$project$Util$Color$colorTheme.bA, $author$project$Util$Color$colorTheme.a$, $author$project$Util$Color$colorTheme.bV, $author$project$Util$Color$colorTheme.bN, $author$project$Util$Color$colorTheme.bB]);
	...
	return A2(
		...
		A2(
			...
			function (i) {
				...
				A2($author$project$Util$Color$hashString, mod, s)),
			colorList));
};
var $rtfeldman$elm_css$Css$inlineBlock = {n: 0, N: 'inline-block'};
					...
					[
						...
						_Utils_ap(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
									$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.b1)
								]),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href(
										'/blog/' + $elm$url$Url$percentEncode(postData.cT)),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(postData.aj)
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$span,
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Html$Styled$text(
									' ' + $author$project$Util$Date$maybeDateToString(postData.ce)),
									A2(
									$rtfeldman$elm_css$Html$Styled$span,
									_List_fromArray(
										[
							...
							A2($author$project$Page$BlogList$viewCategory, maybeCategory, postData.bo)))
					]),
				$author$project$Page$BlogList$renderMarkdown(postData.cY)));
	});
var $author$project$Page$BlogList$viewPostSeparator = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor($author$project$Util$Color$colorTheme.de),
					$rtfeldman$elm_css$Css$height(
	...
	_List_Nil);
var $author$project$Page$BlogList$view = function (model) {
	switch (model.$) {
		case 3:
			var maybeCategory = model.a;
			var m = model.b;
			return {
				u: _List_fromArray(
					[
								...
								_Utils_ap(
									...
									_List_fromArray(
										[
											...
											function () {
												var viewHeaderCategory = function (category) {
													return _List_fromArray(
														[
															A2(
															$rtfeldman$elm_css$Html$Styled$div,
															...
															$author$project$Page$BlogList$viewPostSeparator
														]);
												};
												...
												var appendCategory = $elm$core$Basics$append(
													A2(
														$elm$core$Maybe$withDefault,
														_List_Nil,
														A2($elm$core$Maybe$map, viewHeaderCategory, maybeCategory)));
												if (maybeCategory.$ === 1) {
													return dealEmpty(
														renderPostList(m));
												} else {
			...
			return {
				u: _List_fromArray(
					[
						...
						$author$project$Page$BlogList$viewLoading)
					]),
				aj: 'Blog - kanu.kim'
			};
		default:
					...
					[
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(
									A2($elm$core$Maybe$withDefault, '', maybeCategory))
								])))
					]),
				aj: 'Blog - kanu.kim'
			};
...
var $author$project$Page$BlogPost$decapitalize = function (s) {
	var concatCharString = function (t) {
		var _v0 = t;
		var c = _v0.a;
		var r = _v0.b;
		return _Utils_ap(
	...
	return A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Tuple$mapSecond($elm$core$String$toLower),
				concatCharString),
...
var $rtfeldman$elm_css$Css$noWrap = {aN: 0, a6: 0, N: 'nowrap', Z: 0};
...
var $author$project$Page$PostCategory$viewCategory = function () {
	var middleDot = A2(
		$rtfeldman$elm_css$Html$Styled$span,
		_List_fromArray(
			[
	...
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$List$map($author$project$Page$PostCategory$viewCategoryItem),
		$elm$core$List$intersperse(middleDot));
}();
...
var $author$project$Page$BlogPost$viewContent = function (m) {
	return _List_fromArray(
		[
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
								...
								[
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Css$textAlign($rtfeldman$elm_css$Css$center),
											$rtfeldman$elm_css$Css$lineHeight(
											$rtfeldman$elm_css$Css$em(1.14))
										]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(m.aj)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_Utils_ap(
								_List_fromArray(
									[
										A2($author$project$Util$Icon$icon, _List_Nil, $author$project$Util$Icon$calendar),
										$rtfeldman$elm_css$Html$Styled$text(
										' ' + $author$project$Util$Date$maybeDateToString(m.ce)),
										A2(
										$rtfeldman$elm_css$Html$Styled$span,
										_List_fromArray(
											[
								...
								$author$project$Page$PostCategory$viewCategory(m.bo))),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
...
var $author$project$Page$BlogPost$viewHeader = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
...
var $rtfeldman$elm_css$Css$bold = {S: 0, N: 'bold'};
var $author$project$Page$BlogPost$viewLoading = function (m) {
	return _List_fromArray(
		[
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
...
var $author$project$Util$Icon$BackArrow = 4;
var $author$project$Util$Icon$backArrow = 4;
...
var $rtfeldman$elm_css$Css$calc = F3(
	function (firstExpr, expression, secondExpr) {
		var withoutCalcStr = function (l) {
			return A2($elm$core$String$startsWith, 'calc(', l.N) ? A2($elm$core$String$dropLeft, 4, l.N) : l.N;
		};
		var calcs = A2(
			$elm$core$String$join,
			' ',
		...
		var value = A2(
			...
			_List_fromArray(
				[calcs]));
		return {b9: 0, ar: 0, w: 0, f: 0, av: 0, V: 0, aw: 0, ax: 0, ac: 0, ad: 0, K: 0, aF: 0, N: value};
	});
...
var $author$project$Page$BlogPost$viewNotFoundError = function (slug) {
	return _List_fromArray(
		[
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Css$px(0),
											$rtfeldman$elm_css$Css$px(32)),
											$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.dA)
										]))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('There is no page at the destination /blog/' + (slug + '.'))
										]))
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$p,
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Util$Icon$backArrow),
											A2(
											$rtfeldman$elm_css$Html$Styled$span,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text(' Return to the list')
												]))
										]))
								]))
						]))
...
var $author$project$Util$Icon$Caution = 5;
var $author$project$Util$Icon$caution = 5;
var $rtfeldman$elm_css$Html$Styled$pre = $rtfeldman$elm_css$Html$Styled$node('pre');
var $author$project$Page$BlogPost$viewYamlError = function (error) {
	return _List_fromArray(
		[
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Util$Icon$icon, _List_Nil, $author$project$Util$Icon$caution)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$p,
							_List_Nil,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('This page made the following error while parsing the document:'),
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Css$backgroundColor(
															$rtfeldman$elm_css$Css$hex('F5F5F7')),
															A2(
															$rtfeldman$elm_css$Css$padding2,
															$rtfeldman$elm_css$Css$px(2),
															$rtfeldman$elm_css$Css$px(4)),
															$rtfeldman$elm_css$Css$borderRadius(
															$rtfeldman$elm_css$Css$px(4)),
															$rtfeldman$elm_css$Css$color($author$project$Util$Color$colorTheme.dO),
															$rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$inlineBlock)
														]))
												]),
											_List_fromArray(
...
var $author$project$Page$BlogPost$view = function (model) {
	switch (model.$) {
		case 3:
			var m = model.a;
			return {
				u: _List_fromArray(
					[
						...
						_Utils_ap(
							$author$project$Page$BlogPost$viewHeader,
							$author$project$Page$BlogPost$viewContent(m)))
					]),
				aj: $author$project$Page$BlogPost$decapitalize(m.aj) + ' - kanu.kim'
			};
		case 2:
			var m = model.a;
			return {
				u: _List_fromArray(
					[
						...
						_Utils_ap(
							$author$project$Page$BlogPost$viewHeader,
							$author$project$Page$BlogPost$viewYamlError(m.br)))
					]),
				aj: m.cT + ' - kanu.kim'
			};
		case 0:
			...
			return {
				u: _List_fromArray(
					[
						...
						$author$project$Page$BlogPost$viewLoading(slug))
					]),
				aj: 'kanu.kim'
			};
		default:
			...
			return {
				u: _List_fromArray(
					[
						...
						_Utils_ap(
							$author$project$Page$BlogPost$viewHeader,
							$author$project$Page$BlogPost$viewNotFoundError(slug)))
					]),
				aj: 'Not found - kanu.kim'
			};
	}
};
...
var $author$project$Page$Home$viewMain = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
...
var $author$project$Page$Shortener$ClickButton = {$: 1};
	...
	function (key, argA, argB, argC, argD, argE) {
		return A2(
			...
			A2(
				...
				' ',
				_List_fromArray(
					[argA.N, argB.N, argC.N, argD.N, argE.N])));
	});
var $rtfeldman$elm_css$Css$boxShadow5 = $rtfeldman$elm_css$Css$prop5('box-shadow');
var $author$project$Util$Icon$Copy = 2;
var $author$project$Util$Icon$copy = 2;
var $rtfeldman$elm_css$Css$cursor = $rtfeldman$elm_css$Css$prop1('cursor');
var $rtfeldman$elm_css$Css$default = {c: 0, N: 'default'};
var $author$project$Util$Icon$Ellipsis = 1;
var $author$project$Util$Icon$ellipsis = 1;
...
var $author$project$Util$Icon$RightArrow = 3;
var $author$project$Util$Icon$rightArrow = 3;
var $rtfeldman$elm_css$Html$Styled$Attributes$type_ = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('type');
var $rtfeldman$elm_css$Html$Styled$Attributes$value = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('value');
var $rtfeldman$elm_css$Css$wait = {c: 0, N: 'wait'};
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Page$Shortener$Change),
							$rtfeldman$elm_css$Html$Styled$Attributes$value(model.d_),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$fontFamilies(
									_List_fromArray(
										['Mosk'])),
									$rtfeldman$elm_css$Css$fontSize(
									$rtfeldman$elm_css$Css$em(2.1)),
									$rtfeldman$elm_css$Css$border(
									$rtfeldman$elm_css$Css$px(0)),
									$rtfeldman$elm_css$Css$outline($rtfeldman$elm_css$Css$none),
									$rtfeldman$elm_css$Css$backgroundColor(
									(model.v === 2) ? $rtfeldman$elm_css$Css$hex('cce7ea') : $rtfeldman$elm_css$Css$hex('E4ECF0')),
									A2(
									$rtfeldman$elm_css$Css$padding2,
									...
									$rtfeldman$elm_css$Css$color(
									$rtfeldman$elm_css$Css$hex('40494a'))
								]))
						]),
					_List_Nil),
					A2(
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$hex(
										((model.v === 1) || (model.v === 3)) ? '828788' : '20BACA')),
									$rtfeldman$elm_css$Css$borderRadius(
									...
									(model.v === 1) ? $rtfeldman$elm_css$Css$wait : ((model.v === 3) ? $rtfeldman$elm_css$Css$default : $rtfeldman$elm_css$Css$pointer)),
									$rtfeldman$elm_css$Css$hover(
									((model.v === 1) || (model.v === 3)) ? _List_Nil : _List_fromArray(
										[
											A5(
											...
											$rtfeldman$elm_css$Css$px(-4),
											$rtfeldman$elm_css$Css$hex('14b8ca'))
										]))
								]))
						]),
					_List_fromArray(
						[
							...
							switch (_v0) {
								case 1:
									return A2($author$project$Util$Icon$icon, _List_Nil, $author$project$Util$Icon$ellipsis);
								case 2:
									return A2(
										$author$project$Util$Icon$icon,
										_List_fromArray(
										...
										$author$project$Util$Icon$copy);
								default:
									return A2($author$project$Util$Icon$icon, _List_Nil, $author$project$Util$Icon$rightArrow);
							}
						}()
						]))
				]))
	...
	[
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$text('SHORTENER')
			]))
	]);
var $author$project$Page$Shortener$viewContent = function (model) {
	return _List_fromArray(
		[
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Page$Shortener$viewTitle,
						$author$project$Page$Shortener$viewInput(model)
					])))
		]);
};
var $author$project$Page$Shortener$view = function (model) {
	return {
		u: _List_fromArray(
			[
				A2(
...
var $author$project$Main$viewError = function (error) {
	...
	if (_v0 === 404) {
		return {
			...
			aj: '404 Not found - kanu.kim'
		};
	} else {
		return {
			u: _List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Unknown error occurred.')
				]),
			aj: 'Unknown error occurred - kanu.kim'
		};
	}
};
var $author$project$Main$viewPage = function (model) {
	var map = F2(
		function (pageMsg, _v1) {
			var title = _v1.aj;
			var page = _v1.u;
			return {
				u: A2(
					$elm$core$List$map,
					$rtfeldman$elm_css$Html$Styled$map(pageMsg),
					page),
				aj: title
			};
		});
	...
	switch (_v0.$) {
		case 0:
			...
			return A2(
				...
				$author$project$Page$Home$view(model_));
		case 1:
			var model_ = _v0.a;
			return A2(
				map,
				A2($elm$core$Basics$composeL, $author$project$Main$PageMsg, $author$project$Main$ShortenerMsg),
				$author$project$Page$Shortener$view(model_));
		case 2:
			var model_ = _v0.a;
			return A2(
				map,
				A2($elm$core$Basics$composeL, $author$project$Main$PageMsg, $author$project$Main$BlogListMsg),
				$author$project$Page$BlogList$view(model_));
		case 3:
			var model_ = _v0.a;
			return A2(
				map,
				A2($elm$core$Basics$composeL, $author$project$Main$PageMsg, $author$project$Main$BlogPostMsg),
				$author$project$Page$BlogPost$view(model_));
		case 4:
			return {
				u: _List_fromArray(
					[
...
var $author$project$Main$view = function (model) {
	var _v0 = $author$project$Main$viewPage(model);
	var title = _v0.aj;
	var page = _v0.u;
	return {
		dh: A2(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dx: $author$project$Main$init, dI: $author$project$Main$OnUrlChange, dJ: $author$project$Main$OnUrlRequest, dW: $author$project$Main$subscriptions, dY: $author$project$Main$update, d$: $author$project$Main$view});
